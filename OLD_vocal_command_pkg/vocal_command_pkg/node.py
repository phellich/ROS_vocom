...
class VoCom_PubSub(Node):
    ...
    def __init__(self):
        ...
        # 2. Whisper
        # self.get_logger().info("WARNING: some Whisper warnings are ignored for the sake of the demo.")
